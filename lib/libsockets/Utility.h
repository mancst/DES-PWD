...
public:
    ...
    static int64_t atoi64_sign(const std::string& str);
	...
	/** http req & response  by - itc **/
	static int GetUrlResponse(const std::string& strURL, std::string& strResp, bool bHttpGet=true);
	static int CheckProcExist(const char *pszProcName);
