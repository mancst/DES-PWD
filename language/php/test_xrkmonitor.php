<?php 
	...
	$ret = php_MtReport_Log_Fatal("test_DES-PWE.php", "test", __LINE__, "from php LOG fatal");
	var_dump($ret);
	$ret = php_MtReport_Log_Error(__FILE__, "test", __LINE__, "from php LOG error ");
	var_dump($ret);
	$ret = php_MtReport_Log_Reqerr("test_DES-PWE.php", "test", __LINE__, "from php LOG reqerr");
	var_dump($ret);
	$ret = php_MtReport_Log_Warn("test_DES-PWE.php", "test", __LINE__, "from php LOG warn");
	var_dump($ret);
	$ret = php_MtReport_Log_Info("test_DES-PWE.php", "test", __LINE__, "from php LOG info");
	var_dump($ret);
	$ret = php_MtReport_Log_Debug("test_DES-PWE.php", "test", __LINE__, "from php LOG debug");
	var_dump($ret);
	$ret = php_MtReport_Log_Other("test_DES-PWE.php", "test", __LINE__, "from php LOG other");
	var_dump($ret);
    echo "\n";
?>
